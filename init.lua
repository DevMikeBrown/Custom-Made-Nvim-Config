...
local function BuildAndRunClanguage()
  -- First, compile the program
  vim.fn.jobstart({"gcc", "Main.c", "-o", "Main.exe"}, {
    stdout_buffered = true,
    stderr_buffered = true,
...
-- Optional keybind
vim.keymap.set("n", "<F8>", BuildAndRunClanguage, { desc = "Build and Run C" })
